...
var rootCmd = &cobra.Command{
	Use:   "petra",
	Short: "Private terraform registry server",
	Long:  "Server to get versions of a terraform module in the private registry (Google Cloud Storage bucket) and to get a signed URL to download a module",
